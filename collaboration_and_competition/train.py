...
def train(agent, env, n_episodes=2000, max_t=10000, solved_score=0.5, stop_when_solved=False,
    ...
    """
    max_scores = []  # list containing scores from each episode
    ...
    for i_episode in range(1, n_episodes + 1):
        ...
        max_scores.append(max_score)  # save most recent score
        print('\rEpisode {} \tScore: {:.2f}'.format(i_episode, max_score), end="")
        # print("episode scores: ", scores, end="")
